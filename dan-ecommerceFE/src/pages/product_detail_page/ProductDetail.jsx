  ...
  const makePayment = async (products, quantity) => {
    ...
    try {
      ...
      if (address._id === null || address._id === undefined) {
        ...
        toastError("Please select a delivery address before proceeding to payment.");
        return;
      }
      ...
      toastError("Please Login and select delivery address try again.");
      // alert("Something went wrong with payment. Login Please try again.");
    }
  };
          ...
          <div className="lg:w-[46.76%]  w[100%]  ">
            <div className="w-full h-[85%]   flex flex-col justify-between">
              <div className="w-full flex flex-col justify-between">
                <div className="w-full h-[55%] flex flex-col justify-between">
                  ...
                  <div className="w-full h-[15%]  flex justify-between ">
                    ...
                    <div className="w-[48.4%] h-[3.7rem]">
                      <button onClick={() => makePayment(products, quantity)} className='bg-black w-full h-full rounded-[1vw] text-white text-[1.2rem] font-semibold cursor-pointer'>Buy now</button>
                    </div>
                  </div>
                ...
                {/* Description Section */}
                <div
                  className={`w-full flex flex-col justify-between transition-all duration-500 ${expanded ? "pb-[3vw]" : "pb-[1vw]"
                    }`}
                >
                  ...
                  <div
                    className={`relative overflow-hidden transition-[max-height] duration-700 ease-in-out ${isDesktop
                        ? expanded
                          ? "max-h-[100vh]"
                          : "max-h-[7vw]"
                        : "max-h-none"
                  ...
                  {isDesktop && products?.description?.length > 100 && (
                    <button
                      onClick={() => setExpanded(!expanded)}
                      className="text-blue-500 text-[1vw] mt-2 font-semibold self-start cursor-pointer"
                    >
              ...
              <div className="w-full flex flex-col justify-between">
                ...
                <div className="w-full h-[12.61%] flex justify-between items-center">
                  ...
                  <div className="gap-2 hidden lg:flex">
                    <button
                      onClick={scrollLeft}
                      className="p-2 bg-gray-200 rounded-full hover:bg-gray-300 transition-colors cursor-pointer"
                    >
                      <svg
                        className="w-4 h-4"
                        fill="none"
